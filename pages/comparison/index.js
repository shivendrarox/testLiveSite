...
import Hero from "../../components/comparison/Hero/Hero";
import EndBlock from '../../components/comparison/EndBlock/EndBlock';
import Cards from '../../components/comparison/Cards/Cards';
    ...
    return(
        <>
         {/* <ArticleJsonLd
            ...
            <NextSeo
                title={`Email Marketing Software Comparison with Mailmodo in 2022 - Features, Pricing, Customer Support, Benefits | Mailmodo`}
                description= {`Find out how Mailmodo fares with this email marketing software comparisons for 2022 with deep dive into Pricing, Features, Benifits and more.`}
                canonical={`https://www.mailmodo.com/comparison/`}
                keywords={" "}
                openGraph={{
                    url: `https://www.mailmodo.com/comparison/`,
                    title:`Email Marketing Software Comparison with Mailmodo in 2022 - Features, Pricing, Customer Support, Benifits | Mailmodo`,
                    description: `Find out how Mailmodo fares with this email marketing software comparisons for 2022 with deep dive into Pricing, Features, Benifits and more.`,
                   // type: 'Article',
                    locale: 'en_US',
                   // article: {
...
export async function getStaticProps(context) {
  let response = await fetch("https://mm-strapi-4.azurewebsites.net/competition-pages/");
