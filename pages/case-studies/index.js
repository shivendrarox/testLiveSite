...
import EndBlock from '../../components/case-studies/EndBlock/EndBlock';
import Cards from '../../components/case-studies/Cards/Cards';
    ...
    return(
        <>
         {/* <ArticleJsonLd
            ...
            <NextSeo
                title={`AMP Emails and Email Marketing Case Studies - Campaigns, Success Stories, Best Practices | Mailmodo`}
                description= {`Read these AMP Emails and email marketing case studies, customer stories, and best practices to learn how businesses leveraged these for scaling growth and marketing`}
                canonical={`https://www.mailmodo.com/case-studies/`}
                keywords={" "}
                openGraph={{
                    url: `https://www.mailmodo.com/case-studies/`,
                    title:`AMP Emails and Email Marketing Case Studies - Campaigns, Success Stories, Best Practices | Mailmodo`,
                    description: `Read these AMP Emails and email marketing case studies, customer stories, and best practices to learn how businesses leveraged these for scaling growth and marketing`,
                   // type: 'Article',
                    locale: 'en_US',
...
export async function getStaticProps(context) {
  let response = await fetch("https://mm-strapi-4.azurewebsites.net/customer-stories/");
