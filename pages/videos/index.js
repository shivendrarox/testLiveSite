...
//Page Components
import Hero from "../../components/videopageComponents/Hero/Hero";
...
import EndBlock from '../../components/videopageComponents/EndBlock/EndBlock';
// import Faq from '../../components/newsletterComponents/Faq/Faq';
import Cards from '../../components/videopageComponents/Cards/Cards';
    ...
    return(
        <>
         {/* <ArticleJsonLd
            ...
            <NextSeo
                title={`Growth Marketing and Email Marketing Videos & Livestream - The Growth Chat | Mailmodo`}
                description= {`Watch industry experts and marketers share their experiences, actionable growth marketing strategies, and email marketing best practices.`}
                canonical={`https://www.mailmodo.com/videos/`}
                keywords={" "}
                openGraph={{
                    url: `https://www.mailmodo.com/videos/`,
                    title:`Growth Marketing and Email Marketing Videos & Livestream - The Growth Chat | Mailmodo`,
                    description: `Watch industry experts and marketers share their experiences, actionable growth marketing strategies, and email marketing best practices.`,
                   // type: 'Article',
                    locale: 'en_US',
...
export async function getStaticProps(context) {
  let response = await fetch("https://mm-strapi-4.azurewebsites.net/webinars/");
