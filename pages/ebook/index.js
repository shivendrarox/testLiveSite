...
import Hero from "../../components/ebookcopy/Hero/Hero";
import EndBlock from '../../components/ebookcopy/EndBlock/EndBlock';
import Cards from '../../components/ebookcopy/Cards/Cards';
    ...
    return(
        <>
         {/* <ArticleJsonLd
            ...
            <NextSeo
                title={`Email Marketing eBooks Free Download - Reports, Benchmarks, Best Practices | Mailmodo`}
                description= {`Download ebooks on email marketing by industry experts and growth leaders containing reports, industry, benchmarks, and best practices`}
                canonical={`https://www.mailmodo.com/ebook/`}
                keywords={" "}
                openGraph={{
                    url: `https://www.mailmodo.com/ebook/`,
                    title:`Email Marketing eBooks Free Download - Reports, Benchmarks, Best Practices | Mailmodo`,
                    description: `Download ebooks on email marketing by industry experts and growth leaders containing reports, industry, benchmarks, and best practices.`,
                   // type: 'Article',
                    locale: 'en_US',
