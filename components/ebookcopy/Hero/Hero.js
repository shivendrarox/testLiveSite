            ...
            <div className={styles.hero + " "}>
                ...
                <div className={styles.hero_container+" container"}>
                   <center> <div className={styles.hero_container_left}>
                    <p className={styles.hero_label}>EBOOKS</p>
                        <div className={" " + styles.heading}>
                            <h1 className="">
                            Email Marketing eBooks for Higher Conversions
                            </h1>
                            <p>
                            Read our collection of ebooks on email marketing written in collaboration with industry experts
                             and our team of SMEs, marketers, and growth leaders containing reports, industry benchmarks, and best practices
                            </p>
                        </div>
