...
class Breadcrumb extends Component {
    ...
    routeChangeHandler(path) {
        ...
        if (here && here.length && here[0]) {
         ...
         this.setState({ breadcrumbs: parts.slice(0,this.state.breadcrumbDepth) }); //Allows Home breadcrumb
       // this.setState({ breadcrumbs: parts.slice(1,this.state.breadcrumbDepth) }); //Removes Home breadcrumb
