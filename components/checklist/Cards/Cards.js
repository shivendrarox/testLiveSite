...
const Cards=({ allCardsData,totalNewsletters,totalPages})=>{
    ...
    allCardsData = [{
        ...
        "slug": "get",
        "title": "The Ultimate Email Campaign QA Checklist",
        "description": "Check your email campaigns using our detailed checklist before sending them out. No more cold-feet while hitting the 'Send' button!",
        "details": "Check your email campaigns using our detailed checklist before sending them out. No more cold-feet while hitting the 'Send' button!",
        ...
        "thumbnail": {
          ...
          "width": 2560,
          "height": 1440,
          "url": "https://res.cloudinary.com/mailmodo/image/upload/v1634572839/strapi/Og_image_f06ab67f3d.png",
          "provider_metadata": {
            ...
            <div className="container">
                ...
                return index >= data.minIndex &&
                   index < data.maxIndex &&  (
                    ...
                    <Link passHref href={`/checklist/${item.slug??" "}`}>
                        <a>
