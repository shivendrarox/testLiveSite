            ...
            <div className="container">
                ...
                <div className="row mt-5">
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame1.svg"} ></img>
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame2.svg"} ></img>
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame3.svg"} ></img>
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame4.svg"} ></img>
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame5.svg"} ></img>
                    ...
                    <div className="col-md-4 mt-5">
                        <img className={styles.card_img} src={"/static/images/type1/features2/Frame6.svg"} ></img>
