                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className={styles.card+" pl-5 pr-5"}>
                            ...
                            <img className={styles.round_img+" mt-5"} src={getImageUrl("/static/images/Subhash_Dash.png")}></img>
                    ...
                    <div className="col-md-4">
                        <div className={styles.card+" pl-5 pr-5"}>
                            ...
                            <img className={styles.round_img+" mt-5"} src={getImageUrl("/static/images/Vikas_Kaushal.png")}></img>
                    ...
                    <div className="col-md-4">
                        <div className={styles.card+" pl-5 pr-5"}>
                            ...
                            <img className={styles.round_img+" mt-5"} src={getImageUrl("/static/images/Karanpreet.png")}></img>
