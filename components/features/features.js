    ...
    <div className="home-page">
      ...
      <div className="layout-padding"></div>
        ...
        <div className="col-md-12 d-flex flex-column mx-auto">
          ...
          <div className="d-flex col-md-10 power-card-wrapper justify-content-between mx-auto">
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                <img
                  src="/static/images/feature/banner1.png"
                  className="w-100"
                />
              </div>
        ...
        <div className="easy-amp">
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                <img
                  src="/static/images/feature/banner2.png"
                  className="w-100"
                />
              </div>
              <div className="col-md-5 d-flex flex-column justify-content-center">
        ...
        <div className="easy-amp">
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                <img
                  src="/static/images/feature/banner3.png"
                  className="w-100"
                />
              </div>
              <div className="col-md-5 d-flex flex-column justify-content-center">
        ...
        <div className="easy-amp">
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                <img
                  src="/static/images/feature/banner4.png"
                  className="w-100"
                />
              </div>
              <div className="col-md-5 d-flex flex-column justify-content-center">
        ...
        <div className="easy-amp">
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                <img
                  src="/static/images/feature/banner5.png"
                  className="w-100"
                />
              </div>
              <div className="col-md-5 d-flex flex-column justify-content-center">
      ...
      <div className="cantact-user d-flex align-items-md-center justify-content-center flex-column mx-4 mx-md-auto">
        <h4 className="heading">Always Available at Your Service</h4>
        <div className="contact-wrapper d-flex  align-items-md-center flex-column flex-md-row">
          <div className="contact-number margin-right">
            <img
          ...
          <div className="contact-number">
            ...
            />
            <span>support@mailmodo.com</span>
          </div>
        </div>
      </div>
    </div>
