  ...
  return (
    <>
      ...
      Subscribe
        ...
        {!isEmailValid && (
          <div style={{color:"red",paddingTop:"10px"}} >Please enter a valid email</div>
        )}
        {isEmailSent && (
         
           <div className={styles.message_success} style={{paddingTop:"10px"}} >Thank you for submitting the form. We will connect with you shortly</div>
        )}
    </>
  )
}
