  ...
  const sendTestMail = async () => {
    ...
    try {
      const response = await axios({
        method: 'POST',
        url: 'https://api.mailmodo.com/hooks/start/39ad1a85-3055-4284-ac85-eb3fa438455d',
        data: {
          email,
          data:{
            'name': name,
...
<ul style={{listStyleType:"none",display:"flex",justifyContent:"space-evenly",paddinTop:"26px"}}>
                {/* <li>Share : </li> */}
                <Link href={`https://www.facebook.com/sharer/sharer.php?u=https://www.mailmodo.com/ebook/${"email-performance"}/`}><li style={{cursor:"pointer"}}><img title="facebook" alt="fb.svg" src={fb}></img></li></Link>
                                <Link href={`https://twitter.com/intent/tweet?url=https://www.mailmodo.com/ebook/${"email-performance"}/&text=`}><li style={{cursor:"pointer"}}><img title="Twitter" alt="twitter.svg" src={twitter}></img></li></Link>
                                {/* <Link href={`https://pinterest.com/pin/create/button/?url=https://www.mailmodo.com/ebook/${"email-performance"}/&media=&description=`}><li style={{cursor:"pointer"}}><img title="Pinterest" alt="pinterest.svg" src={pinterest}></img></li></Link> */}
                                <Link href={`https://wa.me/?text=https://mailmodo.com/ebook/${"email-performance"}/`}><li style={{cursor:"pointer"}}><img title="Whatsapp" alt="whatsapp.svg" src={Whatsapp}></img></li></Link>
                                <Link href={`https://www.linkedin.com/sharing/share-offsite/?url=https://mailmodo.com/ebook/${"email-performance"}/`}><li style={{cursor:"pointer"}}><img title="Linkedin" alt="Linkedin.svg" src={Linkedin}></img></li></Link>
