...
const Cards=({allCardsData,totalNewsletters,totalPages})=>{
    ...
    // useEffect(() => {
    //     fetch("https://mm-strapi-4.azurewebsites.net/newsletters/")
    //     .then((response) => response.json())
    //     .then((data) =>
    //       setData({
    //         data:data.reverse(),//logic to show recent posts first
    //         sortedData:data,
      ...
      return(
        ...
        <div style={{backgroundColor:"#ffffff"}} className={styles.Cards+" "}>
            ...
            <div className={"container"}>
                <div className="row">
                <div className="col-md-6"><span className={styles.heading}>Explore newsletters </span></div>
            ...
            <div className="container">
                ...
                return index >= data.minIndex &&
                   index < data.maxIndex &&  (
                    ...
                    <Link passHref href={`/newsletter/${item.slug??" "}`}>
                        <a>
